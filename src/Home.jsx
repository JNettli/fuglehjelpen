                            ...
                            <div className="hero-inner-circle">
                                <div className="hero-text">
                                    ...
                                    <p className="hero-p">
                                        ...
                                        teller <br />
                                        hver fugl vi får reddet. Bli med å gjøre
                                        en forskjell!
                                    </p>
                                    <Link to="/stottoss">
                                        <button>
                                            Bli fuglehjelpgiver i dag!
                                        </button>
                                    </Link>
                                </div>
                            </div>
                ...
                <div className="white-div">
                    <div className="main-div-box">
                        <div className="main-div-textbox">
                            <h1>FUGLEFÔRING</h1>
                            <p>
                                Visste du at du kan gjøre fuglene sterkere og
                                bedre rustet for livets utfordringer bare ved å
                                mate dem? Fuglehjelpen anbefaler fôring av
                                fugler hele året rundt så de er klare for lange
                                trekk eller overvintring. Når en trekkfugl
                                kommer tilbake til nordlige trakter i mai, kan
                                den være så sulten og utmattet at en "dårlig
                                vår" kan ta knekken på den. Da vil et fuglebrett
                                med frø være redningen.
                            </p>
                            <Link to={"/fugleforing"}>
                                <button>Les mer her</button>
                            </Link>
                    ...
                    <div className="main-div-box">
                        <div>
                            <div className="centered">
                                ...
                                <p>
                                    Følg oss på Facebook for å se mer av vårt
                                    arbeid for ville fugler i Norge.
                                </p>
                            </div>
                            <div className="rehab-fugler">
                                ...
                                >
                                    ...
                                    <div className="rehab-fugler-text">
                                        ...
                                        <p>
                                            Denne havsulen fant vi med tråd
                                            hardt rundt nebbet, som aldri ville
                                            løsnet på egenhånd.
                                        </p>
                                    </div>
                                </a>
                                ...
                                >
                                    ...
                                    <div className="rehab-fugler-text">
                                        ...
                                        <p>
                                            ...
                                            dagers hvile på mottaket. Nå er den
                                            klar for det fri igjen!
                                        </p>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div className="main-div-box alt">
                        <div className="main-div-textbox">
                            ...
                            <p className="greentext bigger-text">
                                ...
                                bidrag hjelper! Vi trenger hjelp med alt fra
                    ...
                    <div className="main-div-box">
                        <div className="centered">
                            ...
                            <p>
                                ...
                                villfugler. Ønsker du å støtte <br />{" "}
                                Fuglehjelpen økonomisk, kan du sende et
                                valgfritt beløp til
                            </p>
                            <br />
                            <br />
