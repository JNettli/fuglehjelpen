                            ...
                            <div className="hero-inner-circle">
                                <div className="hero-text alt-movement">
                                    ...
                                    <p className="hero-p alt-text">
                                        Ønsker du å bli en Fuglehjelper? Alt
                                        arbeid hos Fuglehjelpen gjøres av
                                        frivillige, og alle bidrag hjelper! Fyll
                                        ut skjemaet under for å søke.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="sidebyside">
                            ...
                            <div className="sub-div-text">
                                ...
                                <p>
                                    ...
                                    bemanning av telefon til regnskap, bygging
                                    og vedlikehold, grafisk design, koding m. m.
                                    Blant oss er det både biologer og
                                    fuglekjennere til frivillige som er helt nye
                                    til fuglehjelp, men som ønsker å lære, og
                                    bidra.
                                </p>
                                <br />
                                <br />
                                <p>
                                    Fortell oss om dine ferdigheter eller
                                    hvordan du ønsker å hjelpe i søknadsskjemaet
                                    under, så finner vi en plass til deg i
                                    Fuglehjelpen.
                                </p>
                            </div>
                        </div>
                ...
                <div className="white-div">
                    <div className="main-div-box">
                        <div className="form-div">
                            ...
                            <p>
                                Fyll ut skjemaet så godt og utfyllende du kan.
                            </p>
                            ...
                            <form ref={form} onSubmit={handleSubmit}>
                                ...
                                <label htmlFor="relevant-info">
                                    Hvis ja, fortell om erfaringer eller
                                    relevant utdanning
                                </label>
                                ...
                                <label htmlFor="hjelpe-med">
                                    Fortell litt om deg selv og hva du kunne
                                    tenke deg å hjelpe med
                                    <span className="orangetext">*</span>
                                </label>
